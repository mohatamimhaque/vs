...
include('basic.php');
?>
  <nav id="navbar-main" class="navmain">  
    ...
    <ul class="menu-item navbar-nav navsearch">
      <li class="nav-item" >
        <form class="nav-ink m-auto  d-lg-flex search" style="background-color:none">
          <div style="background-color: #e3edf7;" class="mt-2 d-flex InputContainer"> 
            <input type="search" name="search" tabindex="0" id="navsearch" class="" style='box-shadow:none'  placeholder="Search products">
            <a href="#" class="search-btn">
              <i class="fas fa-search"></i>      
            </a>
          </div>
          <div id="bbb" style="position:absolute;top:12vh;width:250px;border-radius:8px;z-index:1110000;">
          </div>
        </form>
      </li>
    </ul>
