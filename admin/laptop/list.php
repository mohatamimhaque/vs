...
$page_title = "Laptop List";

include("../includes/header.php");
include("../includes/navbar.php");

?>
<form action="<?= base_url('admin/laptop/code') ?>" method="POST" class="delete_all">
        ...
        <div class="col-md-12">
            ...
            ?>
                      ...
                      <div class="button-grp overflow-hidden d-flex" style="position:relative">
                          ...
                          <div class="mr-2" style="">
                            ...
                            <div class="hide mr-2" style="">
                                <a class="btn btn-effect btn-outline-secondary"  style="width:90px;padding:11px 0"  href="<?= base_url('admin/laptop/add') ?>">add</a>
                            </div>
                    </div>               
                 </div>
                <div class="card-body">
                ...
                ?>   
                             ...
                             <tbody>
                             <?php
                             $laptop ="SELECT * FROM laptop WHERE status = '0' or status = '2'";
                             $laptop_run= mysqli_query($con, $laptop);
     
                             if(mysqli_num_rows($laptop_run) > 0){
                                 $x=1;
                                 foreach($laptop_run as $item){
                                     ?>
                                     <tr>
                                     <td class="d-flex">
                                         ...
                                         <td style="width:300px;margin:0;overflow:hidden;"><p><?=$item['name'] ?></p></td>
                                        ...
                                        <td><a href="<?=base_url("admin/laptop/edit/").$item['id'] ?>" class="btn btn-outline-info">EDIT</a></td>
                                        <?php
                 if($user_level == "Administrator"){
                   ?>
                      <td>
                           <form action="<?=base_url('admin/laptop/code') ?>" method="POST">
                ...
                <div class="card-body">
                     ...
                     <div class="table-responsive table-2">
                         <table class="table table-stripe" style="text-align:center;color:white" id="example">
                             ...
                             <tbody>
                             <?php
                             $laptop ="SELECT * FROM laptop WHERE status = '1'";
                             $laptop_run= mysqli_query($con, $laptop);
