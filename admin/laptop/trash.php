...
<form class="container-fluid px-4 mt-4" action="<?= base_url('admin/laptop/code') ?>" method="POST">
                 ...
                 <div class="card-header" style="display:flex;justify-content:space-between">
                      ...
                      <div class="ml-5" style="position:relative">
                        ...
                        <div class="hide mr-2" style="">
                            <a class="btn btn-effect btn-outline-secondary"  style="width:90px;padding:11px 0"  href="<?= base_url('admin/laptop/list') ?>">back</a>
                        </div>
                    </div>                 
                </div>
                <div class="card-body">
                     ...
                     <div class="table-responsive">
                         <table class="table table-stripe" style="text-align:center;color:white" id="example">
                             ...
                             <tbody>
                             <?php
                             $laptop ="SELECT * FROM laptop WHERE status='3' ORDER BY id";
